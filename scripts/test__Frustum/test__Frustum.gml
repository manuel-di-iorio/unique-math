...
suite(function() {
    describe("Frustum", function() {
        ...
        test("frustum_clone()", function() {
            ...
            plane_set(f1[0], vec3_create(1, 0, 0), 10);
            var f2 = frustum_clone(f1);
            expect(f2[0][3]).toBe(10);
            plane_set(f2[0], vec3_create(1, 0, 0), 20);
        ...
        test("frustum_copy()", function() {
            ...
            plane_set(f2[0], vec3_create(1, 0, 0), 10);
            frustum_copy(f1, f2);
            expect(f1[0][3]).toBe(10);
        });
        ...
        test("frustum_set()", function() {
            var f = frustum_create();
            var p0 = plane_create(); plane_set(p0, vec3_create(1, 0, 0), 1);
            var p1 = plane_create(); plane_set(p1, vec3_create(-1, 0, 0), 1);
            var p2 = plane_create(); plane_set(p2, vec3_create(0, 1, 0), 1);
            var p3 = plane_create(); plane_set(p3, vec3_create(0, -1, 0), 1);
            var p4 = plane_create(); plane_set(p4, vec3_create(0, 0, 1), 1);
            var p5 = plane_create(); plane_set(p5, vec3_create(0, 0, -1), 1);
        ...
        test("frustum_contains_point_vec()", function() {
            var f = frustum_create();
            plane_set(f[0], vec3_create(1, 0, 0), 1);
            plane_set(f[1], vec3_create(-1, 0, 0), 1);
            plane_set(f[2], vec3_create(0, 1, 0), 1);
            plane_set(f[3], vec3_create(0, -1, 0), 1);
            plane_set(f[4], vec3_create(0, 0, 1), 1);
            plane_set(f[5], vec3_create(0, 0, -1), 1);
        ...
        test("frustum_intersects_box()", function() {
            ...
            plane_set(f[4], vec3_create(0, 0, 1), 1);
            plane_set(f[5], vec3_create(0, 0, -1), 1);
            var b = box3_create(vec3_create(-0.5, -0.5, -0.5), vec3_create(0.5, 0.5, 0.5));
            expect(frustum_intersects_box(f, b)).toBeTruthy();
            var b2 = box3_create(vec3_create(2, 2, 2), vec3_create(3, 3, 3));
        ...
        test("frustum_intersects_sphere()", function() {
            ...
            var sInside = sphere_create(vec3_create(0, 0, 0), 0.5);
            expect(frustum_intersects_sphere(f, sInside)).toBeTruthy();
            
            var sOutside = sphere_create(vec3_create(2, 0, 0), 0.5);
            expect(frustum_intersects_sphere(f, sOutside)).toBeFalsy();
            
            var sIntersect = sphere_create(vec3_create(1.2, 0, 0), 0.5); // center at 1.2, radius 0.5 -> reaches 0.7, intersects plane at 1
